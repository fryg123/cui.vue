...
// require('http://res.7csoft.com/js/cui/web/cui.css');
...
const router = new VueRouter({
    routes: [{
            path: '/uploadfile',
            component: require('./routers/uploadfile.vue')
        },
        {
            path: '/uploadimage',
            component: require('./routers/uploadimage.vue')
        },
        {
            path: '/datagrid',
            component: require('./routers/datagrid.vue')
        },
        {
            path: '/grid',
